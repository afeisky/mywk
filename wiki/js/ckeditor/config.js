...
CKEDITOR.editorConfig = function( config )
{
    ...
    config.filebrowserWindowHeight='70%';//CKFinder浏览窗口高度,默认值70%
    config.filebrowserWindowWidth='60%';//CKFinder浏览窗口宽度,默认值80%

	config.extraPlugins = 'button1'; 
};
